 ...
 * of the Cohort 1 PR 3 Tabs refactor. Behavior, copy, and styling are
 ...
 * (empty / found / launched) so any accidental drift surfaces in CI.
 *
 ...
 * Migrating to TanStack mid-cohort would risk subtle behavior drift
 * in the launch → refetch flow that the snapshot tests can't cover.
 */
